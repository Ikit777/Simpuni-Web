...
const RekapPelaporan: React.FC = () => {
  ...
  const recap = async (data: DefaulRecapType) => {
    ...
    switch (userInfo?.type_user) {
      case "pelapor":
        url = new URL(
          "/api/pelapor/denunciations/export/excel",
          process.env.NEXT_PUBLIC_API_URL
        );
        break;
      case "petugas":
        url = new URL(
          "/api/petugas/denunciations/export/excel",
          process.env.NEXT_PUBLIC_API_URL
        );
        break;
      case "admin":
        url = new URL(
          "/api/admin/denunciations/export/excel",
          process.env.NEXT_PUBLIC_API_URL
        );
        break;
    }
    ...
    try {
      ...
      link.href = fileURL;
      const name = `Rekap Pelaporan ${formatDate(
    ...
    <React.Fragment>
      <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] lg:p-6">
        ...
        <p className="mb-6 text-base text-gray-500 dark:text-gray-400 lg:mb-7">
          Lengkapi formulir dibawah ini untuk membuat rekap pelaporan.
        </p>
