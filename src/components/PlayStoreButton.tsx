...
const PlayStoreButton = ({ dark }: { dark?: boolean }) => {
  return (
    <a href={siteDetails.playstoreUrl}>
      <button
        type="button"
        className={clsx(
      ...
      >
        ...
        <div>
          <div className="text-xs text-slate-100 dark:text-slate-800">
            GET IT ON
          </div>
          <div className="-mt-1 font-sans text-xl font-semibold text-slate-100 dark:text-slate-800">
            Google Play
          </div>
        </div>
      </button>
