...
import BenefitBullet from "./FiturBullet";
...
const FiturSection: React.FC<Props> = ({ benefit, imageAtRight }: Props) => {
      ...
      >
        ...
        >
          <div className="w-full  text-center lg:text-left ">
            ...
            >
              <SectionTitle>
                <h3 className="lg:max-w-2xl text-slate-800 dark:text-slate-100">{title}</h3>
              </SectionTitle>

              <p className="mt-1.5 mx-auto lg:ml-0 leading-normal text-slate-600 dark:text-slate-400">
                {description}
              </p>
            </motion.div>
